...
<head>
  ...
  <title>Login Admin - HijabApps</title>
                ...
                <div class="p-5">
                  ...
                  <form method="POST" action="{{ route('admin.login') }}" aria-label="{{ __('Login') }}">
                    ...
                    <div class="form-group">
                      <input id="username" type="username" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" placeholder="username" value="{{ old('username') }}" required autofocus>
